...
SaturationZValue = 1.4*(100**(1/3)) #The redshift where galaxies are no longer saturated from long exposure. 1.4 is subjectively estimated from Inami et al.'s data and the HUDF image. Multiplying by (100**(1/3)) estimates the 100x sensitivity.
